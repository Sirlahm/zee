...
const FloatingBackground = () => {
  ...
  useEffect(() => {
    // Create random hearts and sparkles
    const count = 50;
...
const ProposalPage = ({ onAccept, onDeny, noBtnPos, moveNoBtn }) => (
  <motion.div
